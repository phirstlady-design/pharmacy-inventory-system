            ...
            <div class="form-body">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="product_name" name="product_name" class="form-control" placeholder="e.g., Aspirin 500mg" required>
                    </div>

                    <div class="row-2cols">
                        <div class="form-group">
                            <label for="nafdacno" class="form-label">NAFDAC Number *</label>
                            <input type="text" id="nafdacno" name="nafdacno" class="form-control" placeholder="e.g., " required>
                        </div>
                    ...
                    <div class="row-2cols">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="barcode" name="barcode" class="form-control" placeholder="e.g., 123456789">
                        </div>
                    ...
                    <div class="row-2cols">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">#</span>
                                <input type="number" id="cost_price" name="cost_price" class="form-control" value="0" min="0" step="0.01">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">#</span>
                                <input type="number" id="selling_price" name="selling_price" class="form-control" value="0" min="0" step="0.01">
                            </div>
                        </div>
                    </div>
