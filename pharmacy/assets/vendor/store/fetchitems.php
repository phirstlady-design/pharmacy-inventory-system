...
$sql = "
    SELECT id, itemname, itemcode, category, storesection, initialprice, supplier, 
           ...
           manufacturedate, expirydate, reservedquantity, reservedfordept, remainingquantity
    FROM (
          ...
          <tbody>
            ...
            if ($result && $result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if ($row['remainingquantity'] <= 10) {
                        $quantityClass = "quantity-low";
                    } else if ($row['remainingquantity'] <= 30) {
                    ...
                    echo "<tr>
                        ...
                        <td><span class='quantity-indicator {$quantityClass}'></span>{$row['remainingquantity']}</td>
                ...
                // echo "<tr><td colspan='14' class='text-center text-muted'>No items found.</td></tr>";
...
<script>
    $(document).ready(function () {
        ...
        function handleDetailsClick() {
            var itemId = $(this).data('id'); // Fetch item ID
            var itemCode = $(this).data('code');

            $.ajax({
                url: 'fetch_item_details.php', // Fetch the details for the item
                type: 'GET',
